...
// 実際のスーパーの店舗内導線（青果→精肉・魚介→惣菜・パン→日配・乳製品→冷凍→乾物・調味料→菓子・飲料→非食品）に合わせた表示順
const CATEGORY_ORDER = [
  "野菜", "果物", "精肉", "魚介", "惣菜", "デザート", "パン類", "乳製品", "日配食品",
  "冷凍食品", "麺類", "乾物・シリアル", "調味料", "加工食品", "菓子", "飲料",
  "ベビーフード", "介護食品", "健康食品", "医薬品", "化粧品",
  "日用品", "季節雑貨", "文房具", "家電", "園芸用品", "玩具",
];
